...
### Step 1
Determine your monitor's resolution and whether you prefer to use Comfortaa font or NewCezanne Pro as your font. Copy the corresponding folder to `/boot/grub/themes`. If you prefer to use Comfortaa, skip to Step 3. If you prefer to use NewCezanne Pro, continue to Step 2.

### Step 2
Make the NewCezanne Pro font files for Grub.
|Folder|Font Sizes|
|---|---|
|`yorha-1920x1080-newcezanne-pro`|16, 18, 24, 36|
|`yorha-2256x1504-newcezanne-pro`|24, 26, 30, 36, 48|
|`yorha-2560x1440-newcezanne-pro`|24, 32, 36, 48|
|`yorha-2880x1800-newcezanne-pro`|24, 32, 36, 48|
|`yorha-3840x2160-newcezanne-pro`|36, 48, 72|


**For example:** Suppose that you already have NewCezanne Pro installed at `~/.local/share/fonts/FOT-NewCezanne Pro/FOT-NewCezanne Pro M.otf`. To create the corresponding font files for `yorha-2880x1800-newcezanne-pro`, use the commands below: 
> ```sh
